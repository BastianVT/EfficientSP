...
for index, file in enumerate(files):
    print("{} over {}".format(index + 1, len(files)))
    ...
    s_items, t_weight, t_profit = solve_knapsack(parameters_, profits_, weights_, capacity_, time_limit=15)
    runtime = time() - start_time

    if 2 <= runtime <= 10:
        print(filepath, runtime)
