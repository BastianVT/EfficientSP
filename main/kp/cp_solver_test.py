...
# from solvers.solver_kp.CP import ort_solve_knapsack
...
#     print(file)
# profits_, weights_, capacity_ = read_knapsack_hard_new("/Users/aglin/Downloads/instances/Genetic_Instances/GACubc_23_10")
profits_, weights_, capacity_ = read_knapsack_hard_new("/Users/aglin/Downloads/instances/Genetic_Instances/GAUnstr_26_1")
# parameters_ = np.random.rand(profits_.shape[1])
parameters_ = np.ones(profits_.shape[1])
s_items, t_weight, t_profit = solve_knapsack(parameters_, profits_, weights_, capacity_)
